...
Next, let's use one of `igraph`'s community detection algorithms to find different clusters of nodes.  We can then add the cluster attribute to the original `igraph` and rebuild our visualization:
